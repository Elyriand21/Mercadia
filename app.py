...
def start_game():
    ...
    if direction == "east":
        ...
        slow_print(
            "The journal’s pages flutter open to a map that sketches itself, marking a building labeled 'The Archive'.\n", 0.01)
        slow_print(
    ...
    # NORTH: Forest/Glade/Monolith Path
        ...
        if action == "drink":
            ...
            direction = input(
                "Do you want to go east, south, or west?: ").strip().lower()
            ...
            if direction == "south":
                ...
                slow_print(
                    "She hesitates. 'Sometimes I dream of their voice. A song in the rain... a hand reaching out. I hold onto that. But dreams fade, don't they?'\n")
                slow_print(
                    "Elyra gazes into the canyon. 'I wonder if they waited. I wonder if they crossed and forgot me too.'\n\n")
                choice = input(
                    "Do you (remember / cross / retreat)?: ").strip().lower()
                if choice == "remember":
                    slow_print(
    ...
    # WEST: The Whispering Vault
        ...
        slow_print(
            "A boy sits at a table of mirrors, weeping.\n'I tried to find her,' he says.\n'But every door just showed me myself.'\n")
        slow_print(
            "'I'm Lorian. She was my sister. Lost when the vault shifted.'\n")
        ...
        slow_print(
            "Lorian looks at you, voice cracking. 'But when I turned... she was gone. I gave everything to chase a reflection.'\n")
        slow_print(
            "He points to three doors: Flame, Ice, and Echo.\n'She went into one. I went into all. None led me to her.'\n")
        door = input(
            "Which door do you enter? (flame/ice/echo): ").strip().lower()
